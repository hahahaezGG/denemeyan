...
exports.run = function(client, message, args) {
    ...
    let reportschannel = message.guild.channels.find(`name`, "rapor-odası");
    if(!reportschannel) return message.channel.send(" `rapor-odası` İsminde Yazı Kanalı Bulamıyorum.!");
